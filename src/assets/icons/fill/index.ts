...
export { ReactComponent as PlayerDropGoalIcon } from './PlayerDropGoal.svg'
export { ReactComponent as PlayerPenaltyIcon } from './PlayerPenalty.svg'
export { ReactComponent as PlayerRealisationIcon } from './PlayerRealisation.svg'
